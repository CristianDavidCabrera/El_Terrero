 ...
 */
final class Version20241116183013 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE team CHANGE id_club_id_id club_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE team CHANGE club_id id_club_id_id INT NOT NULL');
        $this->addSql('ALTER TABLE team ADD CONSTRAINT FK_C4E0A61F7AA03432 FOREIGN KEY (id_club_id_id) REFERENCES club (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
